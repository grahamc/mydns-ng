...
#define DEFINE_RR_TYPE(__TYPENAME__, __PERSISTENT__, __PARSER__, __FREE__, __DUPLICATOR__, \
		       __SIZOR__, __REPLY_ADD__, __UPDATE_GET_RR_DATA__, __WHERECLAUSE__) \
...
DEFINE_RR_TYPE(A6, 1, __mydns_rr_parse_default, __mydns_rr_free_default, \
	       ...
	       __mydns_reply_unknown_type, __mydns_update_get_rr_data_unknown_type, NULL);

DEFINE_RR_TYPE(AAAA, 1, __mydns_rr_parse_default, __mydns_rr_free_default, \
	       __mydns_rr_duplicate_default, __mydns_rr_size_default,  \
	       __mydns_reply_add_aaaa, __mydns_update_get_rr_data_unknown_type, NULL);

#if ALIAS_ENABLED
DEFINE_RR_TYPE(A, 1, __mydns_rr_parse_default, __mydns_rr_free_default, \
	       __mydns_rr_duplicate_default, __mydns_rr_size_default,  \
	       __mydns_reply_add_a, __mydns_update_get_rr_data_unknown_type, " AND (type='A' OR type='ALIAS')");
#else
DEFINE_RR_TYPE(A, 1, __mydns_rr_parse_default, __mydns_rr_free_default, \
	       __mydns_rr_duplicate_default, __mydns_rr_size_default,  \
	       __mydns_reply_add_a, __mydns_update_get_rr_data_unknown_type, NULL);
#endif
...
DEFINE_RR_TYPE(ALIAS, 1, __mydns_rr_parse_default, __mydns_rr_free_default, \
	       __mydns_rr_duplicate_default, __mydns_rr_size_default,  \
	       __mydns_reply_unexpected_type, __mydns_update_get_rr_data_unknown_type, NULL);
#endif
...
DEFINE_RR_TYPE(CNAME, 1, __mydns_rr_parse_cname_etc, __mydns_rr_free_default, \
	        __mydns_rr_duplicate_default, __mydns_rr_size_default,  \
	       __mydns_reply_add_generic_rr, __mydns_update_get_rr_data_unknown_type, NULL);
...
DEFINE_RR_TYPE(MX, 1, __mydns_rr_parse_cname_etc, __mydns_rr_free_default, \
	        __mydns_rr_duplicate_default, __mydns_rr_size_default,  \
	       __mydns_reply_add_mx, __mydns_update_get_rr_data_unknown_type, NULL);

DEFINE_RR_TYPE(NAPTR, 1, __mydns_rr_parse_naptr, __mydns_rr_free_naptr, \
	        __mydns_rr_duplicate_naptr, __mydns_rr_size_default,  \
	       __mydns_reply_add_naptr, __mydns_update_get_rr_data_unknown_type, NULL);
...
DEFINE_RR_TYPE(RP, 1, __mydns_rr_parse_rp, __mydns_rr_free_rp, \
	       ...
	       __mydns_reply_add_rp, __mydns_update_get_rr_data_unknown_type, NULL);
...
DEFINE_RR_TYPE(SRV, 1, __mydns_rr_parse_srv, __mydns_rr_free_default, \
	       ...
	       __mydns_reply_add_srv, __mydns_update_get_rr_data_unknown_type, NULL);
...
DEFINE_RR_TYPE(TXT, 1, __mydns_rr_parse_txt, __mydns_rr_free_default, \
	        __mydns_rr_duplicate_default, __mydns_rr_size_default,  \
	       __mydns_reply_add_txt, __mydns_update_get_rr_data_unknown_type, NULL);
