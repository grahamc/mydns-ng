...
extern void mydns_rrproblem(MYDNS_SOA *soa, MYDNS_RR *rr, const char *name, char *data,
			    const char *fmt, ...) __printflike(5,6);
extern void mydns_check_name(MYDNS_SOA *soa, MYDNS_RR *rr, const char *name, char *data,
